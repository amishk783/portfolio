...
export function Service() {
  return (
    <section id="service" className="pt-24 xl:mb-40 xl:mt-20 xl:pt-16 xl:w-[770px]">
      <div
        className={clsx(
      ...
      <div className="flex flex-col gap-5 justify-between items-start mt-10 max-md:flex-wrap max-md:mt-10 max-md:max-w-full">
