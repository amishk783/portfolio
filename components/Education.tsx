        ...
        <div>
          <div className="relative pl-16 pb-16 space-y-8 timeline ">
            <div className="pt-2">
              ...
              <h3 className=" pt-10  pb-2 text-4xl font-light mb-1 ">Intern</h3>
              <h2 className=" pt-5 pb-7 text-lg text-green-400">Niti Aayog</h2>
              <p className=" text-base leading-7">
                Engineered Python scripts to automate data analysis and
                reporting tasks, resulting in a notable increase in operational
                efficiency by alleviating manual efforts in daily tasks. Devised
                and implemented an algorithm to dynamically identify the School
                of the Month through dashboard reports, significantly enhancing
